...
class MonthAverageGold extends Component {
  constructor(props) {
    super(props);
    this.state = {
      commodity: "",
    ...
    return (
      <div>
        <table className="table table-bordered">
          <tbody>
            <tr>
              <td colSpan="10" align="center"><b>Most Recent Gold Consensus Average -  {this.props.mweji}</b></td>
            </tr>
            <tr>
...
export default MonthAverageGold;
