...
class MonthAverageCopper extends Component {
  constructor(props) {
    super(props);
    this.state = {
      commodity: "",
    ...
    return (
      <div>
        <table className="table table-bordered">
          <tbody>
            <tr>
              <td colSpan="18" align="center"><b>Most Recent Copper Average - {this.props.mweji}</b></td>
            </tr>
            <tr>
...
export default MonthAverageCopper;
