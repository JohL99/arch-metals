...
class Dashboard extends PureComponent {
    ...
    render() {
        ...
        <p className="text-justify">
        The Consensus Metals Panel is aimed at trying to achieve the objective of better informed decision making, by allowing participants to share insights about expected metal prices. Two core considerations are entrenched in the consensus panel approach:</p>
        <p className="text-justify">- No participant is to be compromised through participation, by making all Consensus Metals panel interactions anonymous.</p>
        <p className="text-justify">- All participants on the Consensus Metals panel, will have access to the all same information, and at the same time as other participants.
        </p>
        <br/>
        <h3>General Information</h3>
        <p className="text-justify">
        The structure for inputting forecasts is aimed at making it as easy as possible to submit forecasts, and  ensuring comparability of all forecasts submitted in the reporting layouts. A crucial element of the Consensus Metals panel participation is not only to submit your forecast, but to briefly (Max. 300 characters) provide some justification for your view. Without an understanding of the basis for your  forecast, it limits the value of interacting, and the ability to evolve a more reliable consensus forecast. In the reporting layouts, the data is subdivided into two groups:</p>
