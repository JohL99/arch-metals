        ...
        <table className="table table-bordered">
          <tbody>
            ...
            <tr>
              ...
              <td align="center">
		            <b>${this.state.price1[this.state.novprix]}/oz</b>
	            </td>
              <td align="center">
		            <b>${this.state.price2[this.state.novprix]}/oz</b>
	            </td>
              <td align="center">
		            <b>${this.state.price3[this.state.novprix]}/oz</b>
	            </td>
              <td align="center">
		            <b>${this.state.price4[this.state.novprix]}/oz</b>
	            </td>
              <td align="center">
		            <b>${this.state.price5[this.state.novprix]}/oz</b>
	            </td>
              <td align="center">
		            <b>${this.state.price6[this.state.novprix]}/oz</b>
	            </td>
              <td align="center">
		            <b>${this.state.price7[this.state.novprix]}/oz</b>
	            </td>
              <td align="center">
		            <b>${this.state.price8[this.state.novprix]}/oz</b>
	            </td>
              <td align="center">
		            <b>${this.state.price9[this.state.novprix]}/oz</b>
	            </td>
            </tr>
            <tr>
