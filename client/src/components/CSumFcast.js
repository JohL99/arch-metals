...
class CSumFcast extends PureComponent {
  ...
  trouveev() {
    ...
    if (this.state.avg1[this.state.novpour] === lemax2) {ev[this.state.novpour] = this.state.price1[this.state.novprix];
      ...
      var EVdec = this.state.avg1[this.state.decpour] * this.state.price1[this.state.septprix] ;
      EVdec = EVdec + this.state.avg2[this.state.decpour] * this.state.price2[this.state.septprix] ;
      EVdec = EVdec + this.state.avg3[this.state.decpour] * this.state.price3[this.state.septprix] ;
      EVdec = EVdec + this.state.avg4[this.state.decpour] * this.state.price4[this.state.septprix] ;
      EVdec = EVdec + this.state.avg5[this.state.decpour] * this.state.price5[this.state.septprix] ;
      EVdec = EVdec + this.state.avg6[this.state.decpour] * this.state.price6[this.state.septprix] ;
        ...
        <table className="table table-bordered">
          <tbody>
            ...
            <tr>
              ...
              <td align="center"><b>${this.state.price1[this.state.novprix]}/MT</b></td>
              <td align="center"><b>${this.state.price2[this.state.novprix]}/MT</b></td>
              <td align="center"><b>${this.state.price3[this.state.novprix]}/MT</b></td>
              <td align="center"><b>${this.state.price4[this.state.novprix]}/MT</b></td>
              <td align="center"><b>${this.state.price5[this.state.novprix]}/MT</b></td>
              <td align="center"><b>${this.state.price6[this.state.novprix]}/MT</b></td>
              <td align="center"><b>${this.state.price7[this.state.novprix]}/MT</b></td>
              <td align="center"><b>${this.state.price8[this.state.novprix]}/MT</b></td>
              <td align="center"><b>${this.state.price9[this.state.novprix]}/MT</b></td>
            </tr>
            <tr>
              <td align="center"><b>${this.state.EVnov[this.state.EVnov]/100}/MT</b></td>
