    ...
    return (
      <div>
          ...
          <table className="table table-bordered" style={{ width: "75%" }}>
            <tbody>
              ...
              <tr>
                ...
                <td className="instruction" rowSpan="3" colSpan="11" align="left">
                  <b>Instructions</b>:{" "}
                  <i>
              ...
              <tr>
                ...
                <td>NB: total must sum to 100%</td>
              ...
              <tr>
                ...
                <td colSpan="11">
                  <textarea
                    ...
                    placeholder="NB: If you wish to make any general comments about the consensus copper 
		price forecast or other participant's forecasts. If you wish to share any documents, please 
		paste the relevant website URL here. Please ensure you are permitted to share the document 
		before posting the link.
              ...
              <tr>
                <td className="first" align="center">Submit Forecast</td>
                <td align="center">
                  {/*    <button
                  type="button"
                  name="Submit"
              ...
              <tr>
                <td className="first" align="center">Date</td>
                <td align="center">
