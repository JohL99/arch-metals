            ...
            <tbody>
              ...
              <tr>
                ...
                >
                  ...
                  <i>
                    <td align="justify">
                      Select a month on the <b>Left</b> for which you want to make a copper price forecast. Once the month has been choosen, please select the expected probability you want to assign to each of the indicated price baskets, such that the total probabilities sum to 100%. A total of less or more than 100% will result in a Null forecast.
                      <br/>
              ...
              <tr>
                ...
                <td colSpan="11">
                  <textarea
                    ...
                    wrap="soft"
                    style={{ width: "100%" }}
                    placeholder="Please provide a brief indication of the basis for your copper price forecast in the space provided (Max. 300 characters)."
              ...
              <tr>
                ...
                <td colSpan="11">
                  <textarea
                    ...
                    wrap="soft"
                    style={{ width: "100%" }}
                    placeholder="Please use the general comments section to share your views on the evolving consensus copper price forecast. You can also comment here about other participant's views. If you want to share any documents, please paste the relevant website URL here. Please ensure you are permitted to share the document before posting the link (Max. 300 characters)."
                    onChange={this.onChange}
