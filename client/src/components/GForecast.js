          ...
          <table className="table table-bordered">
            <tbody>
              ...
              <tr>
                ...
                <td align="center"><b>${Math.round(this.trouveEV(this.state.lesmoyennes) * 100)/*Math.round(this.state.EVR)*/}/oz</b></td>
              ...
              <tr>
                ...
                <td align="center"><b>${Math.round(this.state.EVO)/* Math.round(this.trouveEV(this.state.lesmoyennesO)) */}/oz</b></td> 
              ...
              <tr>
                ...
                <td align="center"><b>${Math.round(this.state.EVA)/*Math.round(this.trouveEV(this.state.lesmoyennesA))*/}/oz</b></td>
