...
class GraphPartCopper extends PureComponent {
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.mweji20 !== this.props.mweji20) {
      ...
      leprix20[1] = this.props.mwejiprix20[0].pour1;
      leprix20[2] = this.props.mwejiprix20[0].pour2;
      leprix20[3] = this.props.mwejiprix20[0].pour3;
      leprix20[4] = this.props.mwejiprix20[0].pour4;
      leprix20[5] = this.props.mwejiprix20[0].pour5;
      leprix20[6] = this.props.mwejiprix20[0].pour6;
      leprix20[7] = this.props.mwejiprix20[0].pour7;
      leprix20[8] = this.props.mwejiprix20[0].pour8;
      leprix20[9] = this.props.mwejiprix20[0].pour9;
  ...
  render() {
    return (
      <BarChart
        ...
        width={800}
        height={200}
        data20={this.state.data20 /*this.state.data   this.props.mweji*/}
        margin={{
          top: 5,
          right: 5,
          left: 5,
