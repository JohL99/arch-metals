    ...
    if (prevProps.mweji !== this.props.mweji) {
      ...
      for (y == 0; y < 8 /* this.props.mweji.length */; y++) {
        ...
        if (this.props.mweji[y].lemois == "November 2020") {
          nove20[1] = this.props.mweji[y].price1;
          nove20[2] = this.props.mweji[y].price2;
          nove20[3] = this.props.mweji[y].price3;
          nove20[4] = this.props.mweji[y].price4;
          nove20[5] = this.props.mweji[y].price5;
          nove20[6] = this.props.mweji[y].price6;
          nove20[7] = this.props.mweji[y].price7;
          nove20[8] = this.props.mweji[y].price8;
          nove20[9] = this.props.mweji[y].price9;
        }

        if (this.props.mweji[y].lemois == "December 2020") {
          dece20[1] = this.props.mweji[y].price1;
          dece20[2] = this.props.mweji[y].price2;
          dece20[3] = this.props.mweji[y].price3;
          dece20[4] = this.props.mweji[y].price4;
          dece20[5] = this.props.mweji[y].price5;
          dece20[6] = this.props.mweji[y].price6;
          dece20[7] = this.props.mweji[y].price7;
          dece20[8] = this.props.mweji[y].price8;
          dece20[9] = this.props.mweji[y].price9;
        }
      }

      leprix20[1] = this.props.mwejiprix[0].pour1;
      leprix20[2] = this.props.mwejiprix[0].pour2;
      leprix20[3] = this.props.mwejiprix[0].pour3;
      leprix20[4] = this.props.mwejiprix[0].pour4;
      leprix20[5] = this.props.mwejiprix[0].pour5;
      leprix20[6] = this.props.mwejiprix[0].pour6;
      leprix20[7] = this.props.mwejiprix[0].pour7;
      leprix20[8] = this.props.mwejiprix[0].pour8;
      leprix20[9] = this.props.mwejiprix[0].pour9;
