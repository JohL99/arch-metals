...
import GraphPartGold21 from "./GraphPartGold21";
class GPartFcast extends Component {
  ...
  fillprices(utilisateur, produit) {
    ...
    fetch("/api/beyi/commois/" + "October 2020" + "&Gold")
      ...
      fetch("/api/beyi/commois/" + "March 2021" + "&Gold")
      .then((response) => {
        return response.json();
      })
      .then((data) => {
      ...
      fetch("/api/beyi/commois/" + "June 2021" + "&Gold")
      .then((response) => {
        return response.json();
      })
      .then((data) => {
      ...
      fetch("/api/beyi/commois/" + "September 2021" + "&Gold")
      .then((response) => {
        return response.json();
      })
      .then((data) => {
      ...
      fetch("/api/beyi/commois/" + "December 2021" + "&Gold")
      .then((response) => {
        return response.json();
      })
      .then((data) => {
    ...
    const renderSep20 = (sep20FromApi) => {
      return (
        <tr key={sep20FromApi.id}>
          <td align="center"><b>${sep20FromApi.EV}/oz</b>
          {"  "}
    ...
    const renderOct20 = (oct20FromApi) => {
      return (
        <tr key={oct20FromApi.id}>
          <td align="center"><b>${oct20FromApi.EV}/oz</b>
          {"  "}
    ...
    const renderNov20 = (nov20FromApi) => {
      return (
        <tr key={nov20FromApi.id}>
          <td align="center"><b>${nov20FromApi.EV}/oz</b>
          {"  "}
    ...
    const renderDec20 = (dec20FromApi) => {
      return (
        <tr key={dec20FromApi.id}>
          <td align="center"><b>${dec20FromApi.EV}/oz</b>
          {"  "}
    ...
    const renderMar21 = (mar21FromApi) => {
      return (
        <tr key={mar21FromApi.id}>
          <td align="center"><b>${mar21FromApi.EV}/oz</b>
          {"  "}
    ...
    const renderJun21 = (jun21FromApi) => {
      return (
        <tr key={jun21FromApi.id}>
          <td align="center"><b>${jun21FromApi.EV}/oz</b>
          {"  "}
    ...
    const renderSep21 = (sep21FromApi) => {
      return (
        <tr key={sep21FromApi.id}>
          <td align="center"><b>${sep21FromApi.EV}/oz</b>
          {"  "}
    ...
    const renderDec21 = (dec21FromApi) => {
      return (
        <tr key={dec21FromApi.id}>
          <td align="center"><b>${dec21FromApi.EV}/oz</b>
          {"  "}
    ...
    const renderPrixSep20 = (psep20FromApi) => {
      return (
        <tr key={psep20FromApi.id}>
          ...
          <td align="center"><b>${psep20FromApi.pour1}/oz</b></td>
          <td align="center"><b>${psep20FromApi.pour2}/oz</b></td>
          <td align="center"><b>${psep20FromApi.pour3}/oz</b></td>
          <td align="center"><b>${psep20FromApi.pour4}/oz</b></td>
          <td align="center"><b>${psep20FromApi.pour5}/oz</b></td>
          <td align="center"><b>${psep20FromApi.pour6}/oz</b></td>
          <td align="center"><b>${psep20FromApi.pour7}/oz</b></td>
          <td align="center"><b>${psep20FromApi.pour8}/oz</b></td>
          <td align="center"><b>${psep20FromApi.pour9}/oz</b></td>
    ...
    const renderPrixOct20 = (poct20FromApi) => {
      return (
        <tr key={poct20FromApi.id}>
          <td align="center"><b>{"Expected Value"}</b></td>
          <td align="center"><b>${poct20FromApi.pour1}/oz</b></td>
          <td align="center"><b>${poct20FromApi.pour2}/oz</b></td>
          <td align="center"><b>${poct20FromApi.pour3}/oz</b></td>
          <td align="center"><b>${poct20FromApi.pour4}/oz</b></td>
          <td align="center"><b>${poct20FromApi.pour5}/oz</b></td>
          <td align="center"><b>${poct20FromApi.pour6}/oz</b></td>
          <td align="center"><b>${poct20FromApi.pour7}/oz</b></td>
          <td align="center"><b>${poct20FromApi.pour8}/oz</b></td>
          <td align="center"><b>${poct20FromApi.pour9}/oz</b></td>
          <td colSpan="8" align="center"><b>{"Justifications"}</b></td>
        </tr>
      );
    };
    ...
    const renderPrixNov20 = (pnov20FromApi) => {
      return (
        <tr key={pnov20FromApi.id}>
          <td align="center"><b>{"Expected Value"}</b></td>
          <td align="center"><b>${pnov20FromApi.pour1}/oz</b></td>
          <td align="center"><b>${pnov20FromApi.pour2}/oz</b></td>
          <td align="center"><b>${pnov20FromApi.pour3}/oz</b></td>
          <td align="center"><b>${pnov20FromApi.pour4}/oz</b></td>
          <td align="center"><b>${pnov20FromApi.pour5}/oz</b></td>
          <td align="center"><b>${pnov20FromApi.pour6}/oz</b></td>
          <td align="center"><b>${pnov20FromApi.pour7}/oz</b></td>
          <td align="center"><b>${pnov20FromApi.pour8}/oz</b></td>
          <td align="center"><b>${pnov20FromApi.pour9}/oz</b></td>
          <td colSpan="8" align="center"><b>{"Justifications"}</b></td>
        </tr>
      );
    };
    ...
    const renderPrixDec20 = (pdec20FromApi) => {
      return (
        <tr key={pdec20FromApi.id}>
          <td align="center"><b>{"Expected Value"}</b></td>
          <td align="center"><b>${pdec20FromApi.pour1}/oz</b></td>
          <td align="center"><b>${pdec20FromApi.pour2}/oz</b></td>
          <td align="center"><b>${pdec20FromApi.pour3}/oz</b></td>
          <td align="center"><b>${pdec20FromApi.pour4}/oz</b></td>
          <td align="center"><b>${pdec20FromApi.pour5}/oz</b></td>
          <td align="center"><b>${pdec20FromApi.pour6}/oz</b></td>
          <td align="center"><b>${pdec20FromApi.pour7}/oz</b></td>
          <td align="center"><b>${pdec20FromApi.pour8}/oz</b></td>
          <td align="center"><b>${pdec20FromApi.pour9}/oz</b></td>
          <td colSpan="8" align="center"><b>{"Justifications"}</b></td>
        </tr>
      );
    };
    ...
    const renderPrixMar21 = (pmar21FromApi) => {
      return (
        <tr key={pmar21FromApi.id}>
          <td align="center"><b>{"Expected Value"}</b></td>
          <td align="center"><b>${pmar21FromApi.pour1}/oz</b></td>
          <td align="center"><b>${pmar21FromApi.pour2}/oz</b></td>
          <td align="center"><b>${pmar21FromApi.pour3}/oz</b></td>
          <td align="center"><b>${pmar21FromApi.pour4}/oz</b></td>
          <td align="center"><b>${pmar21FromApi.pour5}/oz</b></td>
          <td align="center"><b>${pmar21FromApi.pour6}/oz</b></td>
          <td align="center"><b>${pmar21FromApi.pour7}/oz</b></td>
          <td align="center"><b>${pmar21FromApi.pour8}/oz</b></td>
          <td align="center"><b>${pmar21FromApi.pour9}/oz</b></td>
          <td colSpan="8" align="center"><b>{"Justifications"}</b></td>
        </tr>
      );
    };
    ...
    const renderPrixJun21 = (pjun21FromApi) => {
      return (
        <tr key={pjun21FromApi.id}>
          <td align="center"><b>{"Expected Value"}</b></td>
          <td align="center"><b>${pjun21FromApi.pour1}/oz</b></td>
          <td align="center"><b>${pjun21FromApi.pour2}/oz</b></td>
          <td align="center"><b>${pjun21FromApi.pour3}/oz</b></td>
          <td align="center"><b>${pjun21FromApi.pour4}/oz</b></td>
          <td align="center"><b>${pjun21FromApi.pour5}/oz</b></td>
          <td align="center"><b>${pjun21FromApi.pour6}/oz</b></td>
          <td align="center"><b>${pjun21FromApi.pour7}/oz</b></td>
          <td align="center"><b>${pjun21FromApi.pour8}/oz</b></td>
          <td align="center"><b>${pjun21FromApi.pour9}/oz</b></td>
          <td colSpan="8" align="center"><b>{"Justifications"}</b></td>
        </tr>
      );
    };
    ...
    const renderPrixSep21 = (psep21FromApi) => {
      return (
        <tr key={psep21FromApi.id}>
          <td align="center"><b>{"Expected Value"}</b></td>
          <td align="center"><b>${psep21FromApi.pour1}/oz</b></td>
          <td align="center"><b>${psep21FromApi.pour2}/oz</b></td>
          <td align="center"><b>${psep21FromApi.pour3}/oz</b></td>
          <td align="center"><b>${psep21FromApi.pour4}/oz</b></td>
          <td align="center"><b>${psep21FromApi.pour5}/oz</b></td>
          <td align="center"><b>${psep21FromApi.pour6}/oz</b></td>
          <td align="center"><b>${psep21FromApi.pour7}/oz</b></td>
          <td align="center"><b>${psep21FromApi.pour8}/oz</b></td>
          <td align="center"><b>${psep21FromApi.pour9}/oz</b></td>
          <td colSpan="8" align="center"><b>{"Justifications"}</b></td>
        </tr>
      );
    };
    ...
    const renderPrixDec21 = (pdec21FromApi) => {
      return (
        <tr key={pdec21FromApi.id}>
          <td align="center"><b>{"Expected Value"}</b></td>
          <td align="center"><b>${pdec21FromApi.pour1}/oz</b></td>
          <td align="center"><b>${pdec21FromApi.pour2}/oz</b></td>
          <td align="center"><b>${pdec21FromApi.pour3}/oz</b></td>
          <td align="center"><b>${pdec21FromApi.pour4}/oz</b></td>
          <td align="center"><b>${pdec21FromApi.pour5}/oz</b></td>
          <td align="center"><b>${pdec21FromApi.pour6}/oz</b></td>
          <td align="center"><b>${pdec21FromApi.pour7}/oz</b></td>
          <td align="center"><b>${pdec21FromApi.pour8}/oz</b></td>
          <td align="center"><b>${pdec21FromApi.pour9}/oz</b></td>
          <td colSpan="8" align="center"><b>{"Justifications"}</b></td>
        </tr>
      );
    };
      ...
      <div>
        <table className="table table-bordered">
          <tbody>
            ...
            <tr>
              ...
              <td align="center"><b>${this.state.evnov20}/oz</b></td>
              <td align="center"><b>${this.state.evdec20}/oz</b></td>
            </tr>
            <tr>
        ...
        <table className="table table-bordered">
          <tbody>
            ...
            <tr>
              <td align="center"><b>${this.state.evdec20}/oz</b></td>
              <td align="center"><b>${this.state.evmar21}/oz</b></td>
              <td align="center"><b>${this.state.evjun21}/oz</b></td>
              <td align="center"><b>${this.state.evsep21}/oz</b></td>
              <td align="center"><b>${this.state.evdec21}/oz</b></td>
            </tr>
            <tr>
            <td rowSpan="12" colSpan="6" width="60%" align="center">
                <GraphPartGold21
