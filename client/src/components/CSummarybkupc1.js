    ...
    const renderPrix = (prixFromApi) => {
      return (
        <tr key={prixFromApi.id}>
          ...
          <td align="center">{prixFromApi.lamoyenne}</td>
    ...
    const renderOld = (arOlddata) => {
      return (
        <tr key={arOlddata.id}>
          ...
          <td align="center">{arOlddata.lamoyenne}</td>
          <td align="center">{arOlddata.dateforecast}</td>
          <td align="center">{arOlddata.price1 * 100}%</td>
          <td align="center">{arOlddata.price2 * 100}%</td>
          <td align="center">{arOlddata.price3 * 100}%</td>
          <td align="center">{arOlddata.price4 * 100}%</td>
          <td align="center">{arOlddata.price5 * 100}%</td>
          <td align="center">{arOlddata.price6 * 100}%</td>
          <td align="center">{arOlddata.price7 * 100}%</td>
          <td align="center">{arOlddata.price8 * 100}%</td>
          <td align="center">{arOlddata.price9 * 100}%</td>
        ...
        <center>
          <table border="1">
            <tbody>
              ...
              <tr>
                <td width="10%">Older Forecasts</td>
                <td>6250 </td>
          ...
          <table className="table table-bordered">
            <tbody>
              <tr>
                <td colSpan="14" align="center" width="100%">
                  <b>Most Recent Forecasts - {this.state.mois}</b>
                </td>
              </tr>
              <tr>
                <td width="10%" align="center">
          ...
          <table className="table table-bordered">
            <tbody>
              <tr>
                <td colSpan="14" align="center" width="100%">
                  <b>Older Forecasts - {this.state.mois}</b>
                </td>
              </tr>
              <tr>
                <td width="10%" align="center">
